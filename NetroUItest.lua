--[[
    NetroUI - UI Library 
    Status: (v5.3.3 - Sidebar Scroll Updated)
    Updates: Added Automatic Scrolling for Sidebar Tabs
]]
...
function Netro65UI:CreateWindow(props)
    ...
    local windowWidth = props.Width or 610 -- Adjusted to 440 for compact fit
    local windowHeight = props.Height or 380 -- Adjusted to 300 for balanced height
    ...
    Netro65UI:CreateWatermark("NetroUI V5.3.3 | " .. LocalPlayer.Name)
    ...
    local NavContainer = Utility:Create("ScrollingFrame", {
        ...
        ScrollBarImageColor3 = Netro65UI.Theme.Accent, -- Matches Theme
