--[[
    NetroUI - UI Library 
    Status: Revised for Request (Bubble Default, Lock Logic, Notification Size)
]]
...
--// Locking System (Updated: Text Only, No Icon)
function Utility:LockElement(instance, text, reasonType)
    ...
    local Overlay = Utility:Create("Frame", {
        ...
        Utility:Create("TextLabel", {
            ...
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0), -- Full size to center
...
--// Helper to check lock status and notify
function Utility:CheckLock(instance)
    if instance:FindFirstChild("LockOverlay") then
        Netro65UI:Notify({
            Title = "Access Denied",
            Content = "Upgrade your Member Status to VIP Member Status",
            Type = "Error",
            Duration = 3
        })
...
function Netro65UI:Notify(props)
    ...
    -- Reduced Height from 75 to 55 for smaller notifications
...
function Netro65UI:CreateWindow(props)
    ...
    --// Bubble Config //
    -- UPDATED: Default to "Text" "NetroUI" if nil
