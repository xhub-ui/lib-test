--[[
    Netro65UI - Professional Modular UI Library (Enhanced Edition V3.5.2)
    Status: COMPLETE & FIXED LAYOUT
    
    Fixed by: AI Assistant
    - Window Size: 600x400 (Compact)
    - Padding/Spacing: Adjusted to prevent overlapping
    - Element Heights: Optimized for better fit
    - Search Bar: Repositioned
    - ESP & Features: Fully included
]]
...
function Netro65UI:CreateWindow(props)
    ...
    local windowWidth = props.Width or 600 -- Fixed Compact Width
    local windowHeight = props.Height or 400 -- Fixed Compact Height
...
Netro65UI:Notify({Title = "Netro65UI V3", Content = "Loaded successfully. Window size optimized.", Duration = 5})
